  ...
  return (
    <aside className="w-14 flex flex-col bg-bg-studio nb-border-l items-center py-4 gap-6 shrink-0 transition-all duration-300 relative z-10">
      ...
      >
        ...
        <div className="absolute right-full top-1/2 -translate-y-1/2 mr-2 bg-black text-white text-[10px] font-bold px-2 py-1 whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-50 shadow-sm border border-black hidden group-hover:block">
          Expand Studio
        </div>
      </button>
      ...
      <div className="mt-auto flex flex-col items-center gap-4 w-full">
        <div className="w-8 h-px bg-gray-300"></div>
        <button className="w-9 h-9 flex items-center justify-center bg-accent-main border border-black shadow-hard-sm text-white hover:-translate-y-0.5 transition-all rounded-sm group relative">
